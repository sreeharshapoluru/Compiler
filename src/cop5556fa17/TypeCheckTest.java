...
public class TypeCheckTest {
	 ...
	 */
	 ...
	 String input = "prog boolean b=true; int b = 77;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog int i=1; int j=2; int k = i+j;";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog int i=10; int j=5; boolean b = i/j*i;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog file fileName=\"http://www.google.com/\";";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog image pic;int array;array[[r,A]]=pic[0,0];";
	 typeCheck(input);
	 }

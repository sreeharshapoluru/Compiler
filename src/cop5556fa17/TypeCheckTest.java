...
public class TypeCheckTest {
	 ...
	 */
	 @Test
	 public void testDec1a() throws Exception {
	  ...
	  */
	 @Test
	 public void testUndec1a() throws Exception {
	 String input = "prog k = 42;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testDec1b() throws Exception {
	 ...
	 @Test
	 public void testUndec1111() throws Exception {
	 ...
	 @Test
	 public void testUndec2111() throws Exception {
	 ...
	 @Test
	 public void testUndec31() throws Exception {
	 ...
	 @Test
	 public void testUndec41() throws Exception {
	 String input = "prog int k=1; int b=2; boolean c = k+b;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec51() throws Exception {
	 String input = "prog image image1; image image2; image1 <- image2;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec61() throws Exception {
	 String input = "prog  image image1; image image2; image1 <- @1;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec71() throws Exception {
	 String input = "prog file imagefile  = \"imageFile2017.\"; image image1;  image1 <- imagefile;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec81() throws Exception {
	 String input = "prog file aa=\"http://example.com/\";";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec91() throws Exception {
	 String input = "raktima url ab=\"world.docx\";";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec101() throws Exception {
	 String input = "abc int def;";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec111() throws Exception {
	 String input = "abc";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec121() throws Exception {
	 String input = "prog int k=2; k=++++k;";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec131() throws Exception {
	 String input = "raktima int k=+r;";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec141() throws Exception {
	 String input = "raktima int k=+r;";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec151() throws Exception {
	 String input = "raktima int k=sin(2);";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec161() throws Exception {
	 String input = "raktima int k=2;k[[x,y]]=2;";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec171() throws Exception {
	 String input = "raktima int k=2;k[[r,A]]=2;";
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec181() throws Exception {
	 String input = "raktima b[[x,y]]=x;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec191() throws Exception {
	 String input = "raktima int b=2;b[[x,y]]=x;";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec201() throws Exception {
	 String input = "raktima url b=\"http://www.google.com\";";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec211() throws Exception {
	 String input = "raktima url b=\"http://www.google.com\";";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec221() throws Exception {
	 String input = "raktima int b=2; int c=4; c=b==c;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec231() throws Exception {
	 String input = "prog int k=k+1;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec241() throws Exception {
	 String input = "prog url b=c;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec251() throws Exception {
	 ...
	 @Test
	 public void testUndec261() throws Exception {
	 String input = "prog int filepng=2;int png=3; image[filepng,png] imageName <- imagepng;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec11111() throws Exception {
	 String input = "Prog url ident = \"asdfadf\";";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 @Test
	 public void testUndec21111() throws Exception {
	 String input = "prog boolean k=true; int k = 5;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 @Test
	 public void testUndec311() throws Exception {
	 String input = "prog int k=1; int b=2; int c = k+b;";
	 //thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 @Test
	 public void testUndec411() throws Exception {
	 String input = "prog int k=1; int b=2; boolean c = k+b;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec511() throws Exception {
	 String input = "prog image image1; image image2; image1 <- image2;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec611() throws Exception {
	 String input = "prog  image image1; image image2; image1 <- @1;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 @Test
	 public void testUndec711() throws Exception {
	 String input = "prog file imagefile  = \"imageFile2017.\"; image image1;  image1 <- imagefile;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog int i = 8<9 ? 89:6586;";
	 typeCheck(input);
	 }
	 @Test
